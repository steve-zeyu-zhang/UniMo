...
PROJECT_ROOT_DIR = "root/autodl-tmp/UniMo"
#print(PROJECT_ROOT_DIR)
sys.path.append(PROJECT_ROOT_DIR)


from action2motion.models import MotionDiscriminator
...
from evaluate.models.PCMG_classfier import P4Transformer_MotionDiscriminator
