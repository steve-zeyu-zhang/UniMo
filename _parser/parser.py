...
def add_options(parser):
    ...
    group.add_argument("--num_epochs", type=int, default=5000, help="AdamW: learning rate")
    group.add_argument("--lr", type=float, default=0.0001, help="AdamW: learning rate")
    group.add_argument("--batch_size", default=16,type=int, help="batch size")
    ...
    group.add_argument("--evaluate_model",default="P4Transformer",choices=[ "GRU","STGCN","P4Transformer"], help="model name")
