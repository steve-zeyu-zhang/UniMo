...
from data.cdflib.dataclasses import AttData, VDRInfo
from data.cdflib.epochs import CDFepoch as cdfepoch
from data.cdflib.logging import logger
...
def cdf_to_xarray(filename: str, to_datetime: bool = True, to_unixtime: bool = False, fillval_to_nan: bool = False) -> xr.Dataset:
    ...
    Example MMS:
        >>> from data import cdflib        >>> # Import necessary libraries
        >>> import xarray as xr
        >>> import os
