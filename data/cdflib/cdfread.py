...
import data.cdflib.epochs as epoch
from data.cdflib._gzip_wrapper import gzip_inflate
from data.cdflib.dataclasses import (
    AEDR,
    VDR,
    ADRInfo,
    AttData,
...
from data.cdflib.s3 import S3object
...
class CDF:
    ...
    Example
    -------
    >>> from data import cdflib
    >>> cdf_file = cdflib.CDF('/path/to/cdf_file.cdf')
    >>> cdf_file.cdf_info()
    >>> x = cdf_file.varget("NameOfVariable", startrec=0, endrec=150)
    """

    def __init__(self, path: Union[str, Path, io.BytesIO], validate: bool = False, string_encoding: str = "ascii", s3_read_method: int = 1):
        """
        Parameters
        ----------
        path : Path, str
