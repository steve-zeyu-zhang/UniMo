...
def arg_parse(is_train=False):
    ...
    ## trans arch
    parser.add_argument("--ff_size", default=1024, type=int, help="sampling step")
    parser.add_argument("--num_layers", default=6, type=int, help="sampling step")
    parser.add_argument("--num_heads", default=4, type=int, help="sampling step")
    parser.add_argument("--dropout", default=0.1, type=int, help="sampling step")
    parser.add_argument("--activation", default="gelu", help="Activation for function for the transformer layers")
    parser.add_argument("--ablation", default=None, choices=[None, "average_encoder", "zandtime", "time_encoding", "concat_bias"],
    ...
    parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='load extended models are saved here')
