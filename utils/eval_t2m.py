...
def evaluation_vqvae(out_dir, val_loader, net, writer, ep, best_fid, best_div, best_top1,
    ...
    if draw:
        ...
        wandb.log({
                'RVQ/Test//FID': fid,
                'RVQ/Test//Diversity': diversity,
                'RVQ/Test//top1': R_precision[0],
                'RVQ/Test//top2': R_precision[1],
                'RVQ/Test//top3': R_precision[2],
                'RVQ/Test//matching_score': matching_score_pred,
                'ep': ep  # Include global step if needed
            })
    if fid < best_fid:
...
def evaluation_mask_transformer(out_dir, val_loader, trans, vq_model, writer, ep, best_fid, best_div,
    ...
    writer.add_scalar('./Test/matching_score', matching_score_pred, ep)
    wandb.log({
            'MaskTransformer/Test/FID': fid,
            'MaskTransformer/Test/Diversity': diversity,
            'MaskTransformer/Test/top1': R_precision[0],
            'MaskTransformer/Test/top2': R_precision[1],
            'MaskTransformer/Test/top3': R_precision[2],
            'MaskTransformer/Test/matching_score': matching_score_pred,
            'ep': ep  # Include global step if needed
        })
...
def evaluation_res_transformer(out_dir, val_loader, trans, vq_model, writer, ep, best_fid, best_div,
    ...
    writer.add_scalar('./Test/matching_score', matching_score_pred, ep)
    wandb.log({
            'ResTransformer/Test/FID': fid,
            'ResTransformer/Test/Diversity': diversity,
            'ResTransformer/Test/top1': R_precision[0],
            'ResTransformer/Test/top2': R_precision[1],
            'ResTransformer/Test/top3': R_precision[2],
            'ResTransforme/Test/matching_score': matching_score_pred,
            'ep': ep  # Include global step if needed
        })
