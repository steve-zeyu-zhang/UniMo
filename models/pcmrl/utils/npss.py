...
def compute_npss(euler_gt_sequences, euler_pred_sequences):
    ...
    gt_fourier_coeffs = np.zeros(euler_gt_sequences.shape, dtype=numpy.complex64)
    pred_fourier_coeffs = np.zeros(euler_pred_sequences.shape, dtype=numpy.complex64)
